...
$query="CREATE TABLE IF NOT EXISTS blood_requests(Id INT(14) NOT NULL AUTO_INCREMENT PRIMARY KEY,user_email TEXT NOT NULL, user_phone TEXT NOT NULL ,blood_group TEXT NOT NULL,required_units INT NOT NULL, request_date TIMESTAMP NOT NULL, status TEXT NULL) ";
